...
tags:
  - nature
header:
  teaser: /assets/images/human-nature/human-nature-cricket-headphones.jpg 
excerpt: "Jill Haefele's \"human:nature\" headphones are populated with live crickets that rustle and chirp behind a mesh screen. "
---
![Tweenbot Medium]({{ site.url }}{{ site.baseurl }}/assets/images/human-nature/human-nature-cricket-headphones.jpg)
human:nature cricket headphones
{: .align-caption}
...
![Tweenbot Medium]({{ site.url }}{{ site.baseurl }}/assets/images/human-nature/ human-nature-child-adi-marom.png){: width="95%"}
human:nature creating delight<br>
<sub>photo by Adi Marom</sub>
{: .align-caption}
...
![Tweenbot Medium]({{ site.url }}{{ site.baseurl }}/assets/images/human-nature/human-nature-adult-wearer.jpg){: width="120%"}
grownup wearing human:nature
{: .align-caption}

# Building Your Own

You can make your own human:nature-style headphones using simple and easily available materials. Many different approaches should work, in fact even a with a [couple of cricket cages](https://a.co/d/7KYBh93) attached to a [head band](https://a.co/d/fneoIPz) would be a good start. If you prefer something closer to Haefele’s design here’s one way to go about it:

Take two small acrylic [snow globes](https://a.co/d/bjBas2x) and drill a hole in the top of each where you can place a small [rubber stopper](https://a.co/d/eg3FKcQ). Use a drill press with a hole cutter bit to make holes all the way through both [headphones](https://a.co/d/dE4O22o), large enough for the base of the snow globes to mate with them.  (Or drill a small starter hole and use a coping saw to make the headphone holes.) Remove any electronics beforehand so nothing gets tangled up in your drill! Place a piece of [wire mesh screen](https://a.co/d/4h45OAb) so that it covers the base of each snow globe. [Silicon adhesive](https://a.co/d/1IwjwYl) can be used to hold it in place. Finally, attach the base of each snow globe to the holes you cut in the headphone using the silicon adhesive. Epoxy also work well with varied materials like these. The wire mesh will serve as a barrier to the crickets, which you can get in and out of the globes using the rubber stopper. Fill the globes with some leaves and a bit of soil, then add a couple [live crickets](https://a.co/d/17yYluh) (carried by pet stores if you don’t want to buy online). Share them with others to spread calm, delight and a direct connection to nature.
